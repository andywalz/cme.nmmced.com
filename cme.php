...
<p><b>HINT:</b> Use the "Print Table" links to display full table views for printing or copy/pasting to Excel</p>
<h2><?php echo $curYear; ?> CME</h2>
<iframe frameborder="0" width="850px" height="70px" src="https://spreadsheets.google.com/a/nmmced.com/tq?tqx=out:html&tq=select+sum(C),+sum(D),+sum(E)+where+H+contains+'<?php echo htmlentities(strtolower($_REQUEST['e'])); ?>'&key=0ArXPuC10_FqvdG1nSEI0VC10cElEN0NwaUd3YVBldnc&sheet=<?php echo $curYear; ?>"></iframe><br>
<a href="https://spreadsheets.google.com/a/nmmced.com/tq?tqx=out:html&tq=select+B,C,D,E,F,G,I,H+where+H+contains+'<?php echo htmlentities(strtolower($_REQUEST['e'])); ?>'&key=0ArXPuC10_FqvdG1nSEI0VC10cElEN0NwaUd3YVBldnc&sheet=<?php echo $curYear; ?>" target="_blank">Print Table &gt;&gt;</a>
<br>
